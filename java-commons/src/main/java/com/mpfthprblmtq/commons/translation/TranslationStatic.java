...
public final class TranslationStatic {

    @Getter @Setter
    private static Locale currentLocale;
    @Getter @Setter
    private static Map<Locale, Dictionary> dictionaries;
    ...
    private static boolean preValidate(String key) {
        return getCurrentLocale() != null && getDictionaries().get(getCurrentLocale()).getDictionaryValues().containsKey(key);
    }

    private static Map<String, String> getActiveDictionaryValues() {
